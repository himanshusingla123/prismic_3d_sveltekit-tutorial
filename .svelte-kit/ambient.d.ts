...
declare module '$env/static/private' {
	...
	export const HADOOP_CLASSPATH_USER_FIRST: string;
	export const HADOOP_HOME: string;
	export const HADOOP_USER_CLASSPATH_FIRST: string;
	export const HIVE_BIN: string;
	export const HIVE_HOME: string;
	export const HIVE_LIB: string;
	...
	export const PYSPARK_HOME: string;
	export const RegionCode: string;
	export const SESSIONNAME: string;
	export const SPARK_HOME: string;
	export const SPARK_LOCAL_HOSTNAME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		GIT_ASKPASS: string;
		HADOOP_CLASSPATH_USER_FIRST: string;
		HADOOP_HOME: string;
		HADOOP_USER_CLASSPATH_FIRST: string;
		HIVE_BIN: string;
		HIVE_HOME: string;
		HIVE_LIB: string;
		HOME: string;
